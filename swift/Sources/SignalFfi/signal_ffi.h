...
typedef int32_t (*SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_SignalType_MutPointer_SignalMutPointerChatRequesterResponse_uint64_t_SignalCStringPtr_SignalCStringPtr_SignalBytestringArray_SignalOwnedBuffer)(SignalType_MutPointer_void, SignalType_MutPointer_SignalMutPointerChatRequesterResponse, uint64_t, SignalCStringPtr, SignalCStringPtr, SignalBytestringArray, SignalOwnedBuffer);
static_assert_64bit(sizeof(SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_SignalType_MutPointer_SignalMutPointerChatRequesterResponse_uint64_t_SignalCStringPtr_SignalCStringPtr_SignalBytestringArray_SignalOwnedBuffer) == 8);
static_assert_64bit(alignof(SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_SignalType_MutPointer_SignalMutPointerChatRequesterResponse_uint64_t_SignalCStringPtr_SignalCStringPtr_SignalBytestringArray_SignalOwnedBuffer) == 8);
typedef struct {
  void* ctx;
  SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_SignalType_MutPointer_SignalMutPointerChatRequesterResponse_uint64_t_SignalCStringPtr_SignalCStringPtr_SignalBytestringArray_SignalOwnedBuffer send;
  SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_uint64_t cancel;
  SignalType_FunctionPointer_void_SignalType_MutPointer_void destroy;
...
static_assert_64bit(offsetof(SignalFfiChatRequesterStruct, cancel) == 16);
static_assert_64bit(offsetof(SignalFfiChatRequesterStruct, destroy) == 24);
static_assert_64bit(sizeof(SignalFfiChatRequesterStruct) == 32);
...
typedef SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_SignalType_MutPointer_SignalMutPointerChatRequesterResponse_uint64_t_SignalCStringPtr_SignalCStringPtr_SignalBytestringArray_SignalOwnedBuffer SignalFfiChatRequesterSend;
...
typedef SignalType_FunctionPointer_int32_t_SignalType_MutPointer_void_uint64_t SignalFfiChatRequesterCancel;
